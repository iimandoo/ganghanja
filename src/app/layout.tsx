...
export const metadata: Metadata = {
  title: "쿨한자 | COOL한자 | 대한검정회 어문회 | 한자능력검정시험",
  description:
    "대한검정회와 어문회 한자능력검정시험 대비 학습 카드입니다. 8급부터 준4급까지 급수별 한자를 재미있게 학습하고 시험에 완벽 대비하세요. 한자 뜻, 음, 예문까지 체계적으로 익힐 수 있습니다.",
  keywords:
    "대한검정회, 어문회, 한자능력검정시험, 한자카드, 한자학습, 한자급수, 8급, 7급, 6급, 준5급, 5급, 준4급, 한자, 한자시험, 한자검정, 급수시험",
  authors: [{ name: "한자급수 시험" }],
